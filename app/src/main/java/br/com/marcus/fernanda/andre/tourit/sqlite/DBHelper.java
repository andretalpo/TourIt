...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase tourItDB) {
        ...
        String sql = String.format("CREATE TABLE %s (%s INTEGER PRIMARY KEY autoincrement, " +
                ...
                "%s INTEGER, " +
                "%s VARCHAR(500)," +
                " CONSTRAINT unique_roteiro UNIQUE (%s));", TABLE_ROTEIRO, COLUMN_ID_ROTEIRO, COLUMN_NOME_ROTEIRO, COLUMN_CRIADOR_ROTEIRO, COLUMN_TIPO_ROTEIRO, COLUMN_NOTA_ROTEIRO, COLUMN_IMAGEM_ROTEIRO, COLUMN_ID_ROTEIRO_FIREBASE, COLUMN_PUBLICADO, COLUMN_SEGUIDO, COLUMN_ROTA, COLUMN_DURACAO, COLUMN_PRECO, COLUMN_DICAS, COLUMN_ID_ROTEIRO_FIREBASE);
